"""
WebSocket Feed Engine — Real-Time Data Stream
===============================================
Go,Y�.î🐺 data streams. - Binance BTC/ETH/SOM/XRP tick data (1s klines + trades)
- Polymarket CLOB orderbook (live bids/asks)

Architecture pattern from reference bots (polyrec, 4coinsbot):
  WebSocket — callback →ܧ shared state dict → strategy engines read latest
